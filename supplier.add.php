...
if(isset($_POST['simpan'])){	
	...
	if(!empty($notif)){
		...
		$query=' insert into supplier set '.substr($query,1,-1);
		...
		<div class="box-body">
			<div class="form-group">
			  <label>Supplier</label>
			   <input type="text" class="form-control" value="<?= !empty($_POST['add_supplier'])?$_POST['add_supplier']:''; ?>" name="add_supplier">
			</div>
			<div class="form-group">
				<label>Barang</label>
			...
			<div class="form-group"> 
			  <label>Harga per satuan @</label>
			   <input type="text" class="form-control" value="<?= !empty($_POST['add_harga'])?$_POST['add_harga']:''; ?>" name="add_harga">
			</div>
	  </div>
